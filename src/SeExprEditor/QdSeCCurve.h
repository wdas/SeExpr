...
*/
#ifndef _QdSeCCurve_h_
#define _QdSeCCurve_h_
...
class QdCBox : public QWidget
{
    Q_OBJECT
public:
    QdCBox(CCurveScene* curveScene, QWidget* parent = 0) : QWidget(parent), _curveScene(curveScene) {}
    ~QdCBox() {}
...
class QdCSwatch : public QFrame
{
    Q_OBJECT
public:
    QdCSwatch(SeVec3d value, QWidget* parent = 0);
    ~QdCSwatch() {}
...
class QdSeCCurve : public QWidget
{
    Q_OBJECT
...
public:
    QdSeCCurve(QWidget* parent = 0, QString pLabel = "", QString vLabel = "", QString iLabel = "",
