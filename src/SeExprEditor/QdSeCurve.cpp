...
QdSeCurve::QdSeCurve(QWidget* parent, QString pLabel, QString vLabel, QString iLabel, 
...
void QdSeCurve::cvSelectedSlot(double pos, double val, T_INTERP interp)
{
    QString posStr;
...
void QdSeCurve::openDetail()
{
    QDialog* dialog=new QDialog();
    dialog->setMinimumWidth(1024);
    dialog->setMinimumHeight(400);
    QdSeCurve* curve=new QdSeCurve(0,"","","",false);
...
void QdSeCurve::addPoint(const double x, const double y, T_INTERP interp, const bool select)
{
