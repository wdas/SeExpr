...
#ifndef QdSeCompletionModel_h
#define QdSeCompletionModel_h
...
class QdSeCompletionModel:public QAbstractItemModel // ItemModel
{
public:
    ...
    // add extras
    void syncExtras(const QdSeCompletionModel& otherModel);

    QdSeCompletionModel(QObject* parent=0);
