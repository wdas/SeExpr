...
void ExprFileDialog::addFavoritesButton(QString dirname, QString linkname,
    QString linkdir)
{
...
QString ExprFileDialog::getOpenFileName( const QString& caption,
...
QStringList ExprFileDialog::getOpenFileNames( const QString& caption,
    const QString& startWith, const QString& filter )
{
    if ( !filter.isEmpty() )
    {
...
QString ExprFileDialog::getExistingDirectory( const QString& caption,
    const QString& startWith, const QString& filter )
{
    if ( !filter.isEmpty() )
    {
...
QString ExprFileDialog::getSaveFileName( const QString& caption,
    const QString& startWith, const QString& filter )
{
    if ( !filter.isEmpty() )
    {
