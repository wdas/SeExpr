...
class ExprVarBlock {
  private:
    ...
    ExprVarBlock(int size) { posix_memalign((void**)&_data, 32, size * sizeof(double)); }
  ...
  public:
    ...
    template <int d>
    Vec<double, d, true> FP(uint32_t variableOffset) {
...
class ExprVarBlockCreator {
  public:
    ...
    ExprVarBlock evaluator() { return ExprVarBlock(_nextOffset); }
