...
struct TypeConversion {
    enum Category { Undefined, NoConversion, VectorToScalar, ScalarToVector };
    ...
    TypeConversion(const ExprType& natural_, const ExprType& final_)
        : category(Undefined), natural(natural_), final(final_)
    {
