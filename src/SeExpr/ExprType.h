...
class ExprType {
 public:
    ...
    ExprType& None(){_type=tNONE;_n=1;return *this;}
    /// Mutate this into a floating point type of dimension d  
    ExprType& FP(int d){_type=tFP;_n=d;return *this;}
    /// Mutate this into a string type 
    ExprType& String(){_type=tSTRING;_n=1;return *this;}
    /// Mutate this into an error type 
    ExprType& Error(){_type=tERROR;_n=1;return *this;}

    ///@}
    ///@{ @name Basic lifetime mutator constructors

    /// Mutate this into a constant lifetime 
    ExprType& Constant(){_lifetime=ltCONSTANT;return *this;}
    /// Mutate this into a uniform lifetime 
    ExprType& Uniform(){_lifetime=ltUNIFORM;return *this;}
    /// Mutate this into a varying lifetime 
    ExprType& Varying(){_lifetime=ltVARYING;return *this;}
    /// Mutate this into a lifetime error 
    ExprType& LifeError(){_lifetime=ltERROR;return *this;}
    ///@}

    /// @{ @name Lifetime propagation and demotion

    //! Assign the lifetime from type a to be my type
    ExprType& setLifetime(const ExprType & a) { _lifetime = a.lifetime(); return *this; }
