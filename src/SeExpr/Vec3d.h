...
class Vec3d {
  public:
    ...
    /** Scalar constructor. */
    Vec3d(double v) { setValue(v, v, v); }

    /** Component constructor. */
    Vec3d(double x, double y, double z) { setValue(x, y, z); }

    /** Array constructor. */
    Vec3d(const double *v) { setValue(v[0], v[1], v[2]); }

    /** Array constructor. */
    Vec3d(const float *v) { setValue(v[0], v[1], v[2]); }
    ...
    Vec3d operator-() const { return Vec3d(-_vec[0], -_vec[1], -_vec[2]); }

    /** Equality comparison. */
    bool operator==(const Vec3d &v) const { return (_vec[0] == v[0] && _vec[1] == v[1] && _vec[2] == v[2]); }

    /** Inequality comparison. */
    bool operator!=(const Vec3d &v) const { return !(*this == v); }

    /** Component-wise binary scalar multiplication. */
    Vec3d operator*(double d) const { return Vec3d(_vec[0] * d, _vec[1] * d, _vec[2] * d); }

    /** Component-wise binary scalar division */
    Vec3d operator/(double d) const { return *this * (1 / d); }

    /** Component-wise binary scalar multiplication. */
    friend Vec3d operator*(double d, const Vec3d &v) { return v * d; }

    /** Component-wise binary vector multiplication. */
    Vec3d operator*(const Vec3d &v) const { return Vec3d(_vec[0] * v[0], _vec[1] * v[1], _vec[2] * v[2]); }
    ...
    const double *getValue() const { return _vec; }
    ...
    /** Inner product. */
    double dot(const Vec3d &v) const { return _vec[0] * v[0] + _vec[1] * v[1] + _vec[2] * v[2]; }

    /** Cross product. */
    Vec3d cross(const Vec3d &v) const {
        return Vec3d(_vec[1] * v[2] - _vec[2] * v[1], _vec[2] * v[0] - _vec[0] * v[2], _vec[0] * v[1] - _vec[1] * v[0]);
    }
    ...
    /** Length of vector. */
    double length() const { return sqrt(_vec[0] * _vec[0] + _vec[1] * _vec[1] + _vec[2] * _vec[2]); }
    ...
    Vec3d orthogonal() const { return Vec3d(_vec[1] + _vec[2], _vec[2] - _vec[0], -_vec[0] - _vec[1]); }
